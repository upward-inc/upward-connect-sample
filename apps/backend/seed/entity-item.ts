...
export async function seedEntityItems(prisma: Prisma.TransactionClient) {
	...
	const activityItems = [
		...
		},
		{
			...
			display_name: "開始日時（実績）",
			type: "date",
			sub_type: "datetime",
		},
		{
			name: "actual_end_date_time",
			display_name: "終了日時（実績）",
			type: "date",
			sub_type: "datetime",
		},
		{
